...
class QuizBoxFiveWords extends StatefulWidget {
  const QuizBoxFiveWords({super.key});

  @override
  State<QuizBoxFiveWords> createState() => _QuizBoxFiveWordsState();
}

class _QuizBoxFiveWordsState extends State<QuizBoxFiveWords> {
  @override
